"""
Raju e Meena adoram jogar um jogo diferente com pequenas peças de mármores, 
chamados Marbles. Eles têm um monte destas peças com números escritos neles. 
...
Cada caso de teste inicia com dois inteiros: 
...
while True:
    ...
    for query in consultas:
        if query in marbles:
            pos = marbles.index(query) + 1  # Posição começa em 1
